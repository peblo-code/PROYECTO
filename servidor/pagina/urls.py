...
urlpatterns = [
    ...
    path('lista_pagare/<int:client_actual>/<int:pagare_actual>', views.lista_pagare, name='lista_pagare'),
    path('pagar_cuota/<int:paga_actual>', views.pagar_cuota, name='pagar_cuota'),
    ...
    path('modal_view_cliente', views.modal_view_cliente, name='modal_view_cliente'),
    ...
    path('parameters_sell', views.parameters_sell, name='parameters_sell'),
    path('timbrado_sell', views.timbrado_sell, name='timbrado_sell'),
    path('factura_sell', views.factura_sell, name='factura_sell'),
    path('edit_timbrado_sell/<int:timbrado_actual>', views.edit_timbrado_sell, name='edit_timbrado_sell'),
    path('edit_factura_sell/<int:factura_actual>', views.edit_factura_sell, name='edit_factura_sell'),
    path('delete_factura_sell/<int:factura_actual>', views.delete_factura_sell, name='delete_factura_sell'),
